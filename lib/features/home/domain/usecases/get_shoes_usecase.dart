...
class GetShoesUsecase implements Usecase<List<ProductModel>> {
  final HomeRepo _homeRepo;

  GetShoesUsecase({required HomeRepo homeRepo}) : _homeRepo = homeRepo;
  @override
  Future<Results<List<ProductModel>, ErrorFailure>> call() async {
    return await _homeRepo.getShoes();
  }
}
